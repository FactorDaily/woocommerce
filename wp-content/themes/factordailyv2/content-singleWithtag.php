...
// The related posts by tags 9 May 2017 GTS
	$the_query = new WP_Query( array('taxonomy' => 'post_tag', 'tag_slug_in' => $tags, 'post__not_in'  =>  $top_story_ids, 'posts_per_page' => 4, 'order' => 'DESC', 'orderby' =>'date', 'fields' => 'ids', 'post_status' => 'publish', 'post_type' => 'post', 'date_query' => array( 'before' => '2 days ago'),) );
