...
<?php
$blogusers = get_users( 'blog_id=1&order=DESC&orderby=post_count&role=administrator&exclude=1,47,6,319,13,95' );
...
<?php
$blogusers = get_users( 'blog_id=1&orderby=rand&role=contributor&exclude=47,6' );
// Array of WP_User objects.
foreach ( $blogusers as $user ) {
