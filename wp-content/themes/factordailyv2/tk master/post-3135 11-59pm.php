...
<html lang="en-US">
   ...
   <style id="moesia-style-inline-css" type="text/css">
      ...
      /*******nsd*********/
         ...
         .banner-h2 {font-size: 48px; color: #fff; border-top: 1px #fff solid; padding: 20px 10px 0px; text-shadow: 1px 1px #999;}
   ...
   <style type="text/css">
      .has-banner-cover{
         height: 95%;
         background: url('http://fdthird.staging.wpengine.com/wp-content/uploads/2016/10/Binny_Bansal_Flipkart_Lead_3.jpg') no-repeat center center; 
...
-->
			...
			<div style="position: relative; height: 100%; text-align: center;">
                <div style="position: absolute; bottom: 10%; padding: 10px 40px">
                   <h2 class="banner-h2"> Flipkart Big Billion Sale  </h2>
                   <h4 class="banner-h4"> By Jaydevan & Pankaj </h4> 
                   	<div>
                     ...
                     <div id="pl-2040">
                                 ...
                                 <section id="services" class="services-area">
                                    <div class="container">
                                       ...
                                       <div class="service col-md-offset-2 col-md-8 col-xs-12">
                                          <div class="text-font-family service-desc" style="visibility: visible; ">
                                            <p class="dropcap"> Lorem Ipsum&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
                        ...
                        <div class="panel-grid" id="pg-2040-1">
                           <div class="panel-grid-cell" id="pgc-2040-1-0">
                              <section id="call-to-action" class="action-area" style="padding: 139px 0;  display: block; background: url('http://fdthird.staging.wpengine.com/wp-content/uploads/2016/10/flipkart-inside2.jpg') no-repeat; background-position: center top; background-attachment: fixed; background-size: cover; z-index: -1;">
                  ...
                  <div class="row">
                     <div class="col-sm-2 hidden-xs">
                        <a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
                           <img src="/wp-content/themes/_tk-master/images/factordaily.svg" style="max-width: 80%;">
                        </a>
                     </div>
