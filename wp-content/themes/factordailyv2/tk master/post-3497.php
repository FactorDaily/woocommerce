...
/**
* WP Post Template: test template
*/
...
<section class="hero">
	<div id="cover">
		<div id="title">
			<h2 class="banner-h2"> Unfazed by Dabholkar’s murder, rationalists in Maharashtra are still fighting his battle </h2>
					...
					<div class="panel-grid" id="pg-2040-1-2">
						<div class="panel-grid-cell" id="pgc-2040-1-0">
							<section id="call-to-action">
									<iframe class="jumbotron myframe" src="https://www.youtube.com/embed/slRKYZHixfk" frameborder="0" marginwidth="0" allowfullscreen></iframe>
							</section>
						...
						<section id="services" class="services-area">
							<div class="container">
								<div class="service col-md-offset-2 col-md-8 col-xs-12">
									...
									<p>
									But, it was a disaster. Nearly 1.5 million customers ended up buying from the retailer on October 6, 2014. At Flipkart, they were underprepared. “People were expecting 5x; what we got was 30x,” says Bansal. It literally broke Flipkart. Stocks ran out pretty quickly, cancellations were high, the website couldn’t take the traffic, warehouses got cluttered, it was mayhem at air cargo locations… . Customers were mad. </p>
									<p>Sachin Bansal, then CEO of Flipkart, had to apologise to customers. “...though we saw unprecedented interest in our products and traffic like never before, we also realized that we were not adequately prepared for the sheer scale of the event,” he wrote in a <a href="http://www.thehindu.com/business/Industry/flipkart-accepts-shoddy-performance-apologises-for-glitches/article6478831.ece" class="link-style" target="_blank">letter</a> to customers.</p>
									<p>Yet, it was clear that Flipkart was on to a good idea. It <a href="http://www.financialexpress.com/industry/companies/flipkarts-big-billion-days-sale-churns-out-300-million-gmv/153290/" target="_blank" class="link-style">sold</a> goods worth over $100 million in its first BBD. Its 2015 BBD didn’t have the outages of the previous years but it had its limitations because it was an app-only sale. Still, it sold goods worth over $300 million.</p>
									<p>Since then, Flipkart has been through a lot. The company has restructured the organisation twice, many old timers have left, and competition from Amazon has intensified. To top it all, the market had started to stagnate. <a href="http://factordaily.com/project-fixkart-binny-bansal-flipkart/" target="_blank" class="link-style">As we wrote earlier</a>, online retailers had shipped about 26 million units in the April-June 2016, just about the same as the previous two quarters. Bansal says this worries him and insists it is up to Flipkart, as the market leader, to lead efforts to grow the market again. </p>
									<br />
							...
							<div class="panel-grid-cell" id="pgc-2040-0-0">
								<section id="services" class="services-area">
									<div class="container">
										...
										<div class="service col-md-offset-2 col-md-8 col-xs-12">
											<div class="text-font-family" style="visibility: visible; ">
												<p>Surojit Chatterjee, a former Googler who joined Flipkart in November 2015, shows us  a new feature developed by the engineering team that helps the company offer exchange offers for old phones on the fly. If an iPhone 6 user wants to trade in her phone for a new iPhone 7 on Flipkart, the feature runs checks on the existing phone to offer the best price. The software runs a check on several parameters such as battery, camera, Wi-Fi, volume button, GPS and speaker condition to determine the phone’s health. Earlier, the phones had to be returned after realising that the exchanged products weren't in working condition. Chatterjee used to lead product development for Google’s mobile advertising and search business. </p><p>
