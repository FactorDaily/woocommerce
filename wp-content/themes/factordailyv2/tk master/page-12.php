...
get_header(); ?>
<div class="row">
	<?php query_posts( 'category_name=featured_lifestyle&posts_per_page=1' ); ?>
		<?php while ( have_posts() ) : the_post(); ?>
				<div class="jumbotron" style="background:url(<?php the_post_thumbnail_url();?>) no-repeat center center; background-size:cover">
						<div class="black-overlay">
							<div id="post-<?php the_ID(); ?>" class="category-lifestyle">
...
<section id="latest-factors" class="row">
		<div class="container">
			...
			<div id="lifestyle" class="row row-margin-bottom">
				<?php query_posts( 'category_name=lifestyle&order=DSC&posts_per_page=70' ); ?>
				<?php while ( have_posts() ) : the_post(); ?>
