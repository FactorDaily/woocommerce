...
<div class="wrap">
	...
	<?php 
		...
		if($i == 1 ||  $i == 5) {
			...
			echo "<div class='lead-story-single padding-left-even story_".$i ." ". $col5."'>";
		...
		if($i == 4 ) {
			echo "<div class='lead-story-single col-sm-6 col-md-6 col-lg-6 col-xs-6 padding-right-odd'>";
			include( locate_template( 'content-lead-stories.php', false, false ) );			
			echo "</div>";	
...
<!-- makers -->
    <div class="row" >
      	<div class="wrapper">
<?php //Maker Stories
	get_template_part( 'makers', get_post_format() );
	?>
    	</div>
    </div>
<!-- end makers -->
...
<?php 	
$blogusers = get_users( 'blog_id=1&orderby=rand&role=administrator&exclude=1,47,46,6,319,13,95' );
// Array of WP_User objects.
foreach ( $blogusers as $user ) {
	
    echo '<a href="'.get_author_posts_url( $user->ID ).'"><div class="author-card"><img src="'.$user->teampic.'" /></div></a>';
};?>
<?php
