    ...
    <header class="hidden-xs hidden-sm">
      	<div id='contentasda' class="head-wrapper  head-scroll">
	      	...
	      	<div class="sticky-header">
				...
				<div class="fdtopeventbar"><h5><a class="event-head">ProductHunt Bengaluru Meetup on September 07, 2017&nbsp;&nbsp;</a><a class="btn btn-warning" href="https://factordaily.com/product-hunt-bengaluru-factordaily-meetup-2017/">Signup!</a></span></h5></div>
