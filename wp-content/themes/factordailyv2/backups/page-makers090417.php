...
<div class="foj-nav fixedElement" style="display: none">
	<div class="container">
		<div class="service col-md-offset-1 col-md-10 col-xs-12">
...
<?php echo do_shortcode('[contact-form-7 id="4443" title="Maker form"]'); ?>
											</div>
										</div>
				...
				<div class="wrap filter-stories">
			        ...
			        <h2 class="makers-story-area-heading"> Here are some of our recent videos.</h2>
					<div class="hidden-xs">
