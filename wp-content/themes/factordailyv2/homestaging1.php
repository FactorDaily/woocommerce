...
#------------------get the event query--------------------#
    ...
    <div class="newlayout lead-stories remove-padding">
        <?php 
            $i = 0 ;
            $lead_array=array();
            ...
            <?php  } ; ?>
                ...
                <?php  $lead23 == ''; ?>
                <?php if($i == 2 || $i == 3 ){  ?>
                <div class="lead-story-single col-md-12 col-xs-6 remove-padding-right"><?php include( locate_template( 'content-lead-stories.php', false ,true ) ) ; ?></div>
        ...
        <!-- first row-->
        <div class="row">
                <div class="col-md-8 col-xs-12 lead-story-single first-lead remove-padding-mob remove-padding-left">
                    <?php echo  $lead1 ;  ?>
                </div>
            <div class="col-md-4 col-xs-12 lead-story-single side-lead remove-padding-mob remove-padding-right">
                    <?php echo  $lead23 ; ?>
            </div>
        </div>
        ...
        <!-- whatsapp events etc-->
        <div class="row special-section hidden-xs">
            <div class="col-md-6 outlier-special"><a href="https://factordaily.com/?s=outliers"><img class="img-responsive" src="<?php echo get_bloginfo('stylesheet_directory'); ?>/images/outlier.jpg" /></a></div>
            <div class="col-md-6 event-special">
            <?php 
				if ( $lastposts ) {
				foreach ( $lastposts as $post ) :
					setup_postdata( $post ); 
					echo '<a href="'.get_permalink().'" target="_blank">'.get_the_post_thumbnail( get_the_ID(), 'lead5', array( 'class' => 'img-responsive ' ) ).'</a>';
				endforeach; 
				wp_reset_postdata();
				}			
				?>
			</div>
            <div class="col-md-6 whatsapp-special">
					...
					<div class="col-md-12 col-sm-12 col-lg-12 hidden-xs">
						...
						<form action="<?php bloginfo('stylesheet_directory'); ?>/whatsapp_process.php" method="post" name="whatsappdata" class="whatsapp-form" >
			   			...
			   			<div class="visible-md visible-lg visible-sm hidden-xs">
			   				<p style="color: #fff;">Enter your name and press the WhatsApp icon</p>
            			</div>
               		</div>
        ...
        <div class="row">
        <?php if($i == 6 ){  ?>
            <div class="col-sm-4 hidden-xs"><?php echo $lead6; ?></div>
        <?php } ?>
	...
	<div class="future-stories row">
		...
		<?php 
			...
			if($i == 1 ) {
				...
				include( locate_template( 'future.php', false, false ) );
				echo "</div>";
				echo "<div class='side-stories  col-md-3 col-xs-12 remove-padding-right'>";
			} else {
				if($i == 2){
