...
<div class="author-wrap">     
    <div class="author-story-stack">
		<?php 	$query = new WP_Query( 'posts_per_page=15&order=DESC&orderby=post_date&ignore_sticky_posts=1&post_type=fd_news' );  ?>
      ...
      <?php   wp_reset_postdata();
        echo do_shortcode('[ajax_load_more repeater="template_3" order="DESC" orderby="post_date" offset="15" post_type="fd_news"]');
        ?>
	</div>
</div>
