 ...
 * @since Factordaily V2 1.1
 */

get_header();  ?>
	<header class="page-header">
 		<h1 class="page-title">Stories from <strong><?php echo single_cat_title(); ?></strong></h1>
	</header><!-- .page-header -->
...
$query = new WP_Query( 'posts_per_page=2&order=DESC&orderby=post_date&ignore_sticky_posts=1&post_type=fd_blog&paged='.$paged );  ?>
      ...
      <?php   wp_reset_postdata();
        echo do_shortcode('[ajax_load_more repeater="template_3" order="DESC" orderby="post_date" offset="15" post_type="fd_blog"]');
        ?>
	</div>
</div>
