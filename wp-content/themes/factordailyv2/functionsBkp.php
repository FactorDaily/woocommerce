...
//Counts by GTS
		...
		$content .= '<span class="facebook"><a  href="'.$facebookURL.'" target="_blank" ><i class="fa fa-facebook" aria-hidden="true"></i></a><i class="count">'.$fbcount.'</i></span>';
		...
		$content .= '<span class="reddit"><a  href="'.$redditURL.'" target="_blank"><i class="fa fa-reddit-alien" aria-hidden="true"></i></a><i class="count">'.$redditcount.'</i></span>';
...
return '<div class="subscribe-whatsapp col-md-12 col-xs-12">
				...
				<div class="col-md-6 col-sm-6 col-lg-6 hidden-xs">
                     <form action="https://factordaily.com/wp-content/themes/factordailyv2/whatsapp_process.php" method="post" name="whatsappdata" class="whatsapp-form" >
                      <input name="text" type="text" placeholder="Enter your name" class="whatsappnameW" required title="Please enter your name, not number" pattern="[a-zA-Z\s]+" value=""/>
